...
const EUROPE_DEALS: TrendingDeal[] = [
  ...
  createTrendingDeal('eu-bos-lhr', 'BOS', 'Boston', 'LHR', 'London', 'United Kingdom', '2026-09-12', '2026-09-19', 'From 30k pts', 'From $489', 'Aeroplan', { highlightRoundTrip: true }),
  createTrendingDeal('eu-ewr-fco', 'EWR', 'New York', 'FCO', 'Rome', 'Italy', '2026-11-07', '2026-11-14', 'From 33k pts', 'From $548', 'United MileagePlus'),
  createTrendingDeal('eu-lax-lhr', 'LAX', 'Los Angeles', 'LHR', 'London', 'United Kingdom', '2026-10-11', '2026-10-21', 'From 38k pts', 'From $612', 'British Airways Avios', { highlightRoundTrip: true }),
  ...
  createTrendingDeal('eu-sfo-cdg', 'SFO', 'San Francisco', 'CDG', 'Paris', 'France', '2026-11-02', '2026-11-12', 'From 36k pts', 'From $589', 'Flying Blue', { highlightRoundTrip: true }),
  createTrendingDeal('eu-mia-lis', 'MIA', 'Miami', 'LIS', 'Lisbon', 'Portugal', '2026-11-14', '2026-11-21', 'From 27k pts', 'From $478', 'TAP Miles&Go'),
  createTrendingDeal('eu-ord-fco', 'ORD', 'Chicago', 'FCO', 'Rome', 'Italy', '2026-10-25', '2026-11-01', 'From 34k pts', 'From $528', 'United MileagePlus', { highlightRoundTrip: true }),
];
...
const ASIA_PACIFIC_DEALS: TrendingDeal[] = [
  ...
  createTrendingDeal('ap-lax-hnd', 'LAX', 'Los Angeles', 'HND', 'Tokyo', 'Japan', '2026-10-18', '2026-10-28', 'From 40k pts', 'From $789', 'ANA via Amex', { highlightRoundTrip: true }),
  ...
  createTrendingDeal('ap-lax-icn', 'LAX', 'Los Angeles', 'ICN', 'Seoul', 'South Korea', '2026-10-30', '2026-11-09', 'From 37k pts', 'From $698', 'Korean Air Skypass', { highlightRoundTrip: true }),
  createTrendingDeal('ap-ord-han', 'ORD', 'Chicago', 'HAN', 'Hanoi', 'Vietnam', '2026-09-08', '2026-09-18', 'From 42k pts', 'From $728', 'Aeroplan'),
  createTrendingDeal('ap-lax-sin', 'LAX', 'Los Angeles', 'SIN', 'Singapore', 'Singapore', '2026-10-22', '2026-11-01', 'From 33k pts', 'From $745', 'Singapore KrisFlyer', { highlightRoundTrip: true }),
  ...
  createTrendingDeal('ap-lax-bkk', 'LAX', 'Los Angeles', 'BKK', 'Bangkok', 'Thailand', '2026-11-18', '2026-11-28', 'From 32k pts', 'From $689', 'Cathay Asia Miles', { highlightRoundTrip: true }),
...
const AMERICAS_DEALS: TrendingDeal[] = [
  ...
  createTrendingDeal('am-jfk-sju', 'JFK', 'New York', 'SJU', 'San Juan', 'Puerto Rico', '2026-07-24', '2026-07-31', 'From 8k pts', 'From $178', 'JetBlue TrueBlue', { highlightRoundTrip: true }),
  ...
  createTrendingDeal('am-mia-gru', 'MIA', 'Miami', 'GRU', 'São Paulo', 'Brazil', '2026-10-04', '2026-10-14', 'From 28k pts', 'From $498', 'LATAM Pass', { highlightRoundTrip: true }),
  ...
  createTrendingDeal('am-mia-gua', 'MIA', 'Miami', 'GUA', 'Guatemala City', 'Guatemala', '2026-10-14', '2026-10-21', 'From 12k pts', 'From $268', 'United MileagePlus', { highlightRoundTrip: true }),
  ...
  createTrendingDeal('am-bos-sju', 'BOS', 'Boston', 'SJU', 'San Juan', 'Puerto Rico', '2026-08-08', '2026-08-15', 'From 10k pts', 'From $192', 'JetBlue TrueBlue', { highlightRoundTrip: true }),
...
const MIDDLE_EAST_AFRICA_DEALS: TrendingDeal[] = [
  ...
  createTrendingDeal('me-jfk-dxb', 'JFK', 'New York', 'DXB', 'Dubai', 'United Arab Emirates', '2026-10-09', '2026-10-19', 'From 45k pts', 'From $698', 'Emirates Skywards', { highlightRoundTrip: true }),
  ...
  createTrendingDeal('me-lax-nbo', 'LAX', 'Los Angeles', 'NBO', 'Nairobi', 'Kenya', '2026-11-15', '2026-11-29', 'From 48k pts', 'From $798', 'Kenya Airways Asante', { highlightRoundTrip: true }),
  ...
  createTrendingDeal('me-jfk-acc', 'JFK', 'New York', 'ACC', 'Accra', 'Ghana', '2026-08-22', '2026-09-01', 'From 40k pts', 'From $658', 'United MileagePlus', { highlightRoundTrip: true }),
  ...
  createTrendingDeal('me-ord-add', 'ORD', 'Chicago', 'ADD', 'Addis Ababa', 'Ethiopia', '2026-09-06', '2026-09-16', 'From 42k pts', 'From $672', 'Ethiopian ShebaMiles', { highlightRoundTrip: true }),
];
