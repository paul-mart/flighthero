...
const ASIA_PACIFIC_DEALS: TrendingDeal[] = [
  ...
  createTrendingDeal('ap-sfo-hnd', 'SFO', 'San Francisco', 'HND', 'Tokyo', 'Japan', '2026-09-14', '2026-09-24', 'From 38k pts', 'From $752', 'United MileagePlus'),
  ...
  createTrendingDeal('ap-jfk-hnd', 'JFK', 'New York', 'HND', 'Tokyo', 'Japan', '2026-11-05', '2026-11-15', 'From 55k pts', 'From $892', 'ANA via Amex'),
  createTrendingDeal('ap-ord-icn', 'ORD', 'Chicago', 'ICN', 'Seoul', 'South Korea', '2026-09-08', '2026-09-18', 'From 42k pts', 'From $712', 'Aeroplan'),
...
const AMERICAS_DEALS: TrendingDeal[] = [
  ...
  createTrendingDeal('am-bos-mex', 'BOS', 'Boston', 'MEX', 'Mexico City', 'Mexico', '2026-11-08', '2026-11-15', 'From 14k pts', 'From $258', 'Aeroplan'),
  createTrendingDeal('am-jfk-mex', 'JFK', 'New York', 'MEX', 'Mexico City', 'Mexico', '2026-08-28', '2026-09-04', 'From 13k pts', 'From $239', 'Flying Blue'),
  ...
  createTrendingDeal('am-lax-mex', 'LAX', 'Los Angeles', 'MEX', 'Mexico City', 'Mexico', '2026-10-14', '2026-10-21', 'From 11k pts', 'From $228', 'Aeroplan'),
  ...
  createTrendingDeal('am-lax-sju', 'LAX', 'Los Angeles', 'SJU', 'San Juan', 'Puerto Rico', '2026-11-22', '2026-11-29', 'From 12k pts', 'From $205', 'JetBlue TrueBlue'),
];
...
const MIDDLE_EAST_AFRICA_DEALS: TrendingDeal[] = [
  ...
  createTrendingDeal('me-mia-gru', 'MIA', 'Miami', 'GRU', 'São Paulo', 'Brazil', '2026-10-04', '2026-10-14', 'From 28k pts', 'From $498', 'LATAM Pass'),
...
export const REGIONAL_DEAL_SECTIONS: RegionalDealSection[] = [
  ...
  },
  {
    id: 'asia-pacific',
    title: 'Asia & Pacific',
    description: 'Long-haul redemptions to Tokyo, Seoul, Singapore, Sydney, and more.',
    slides: chunkDealsIntoSlides(ASIA_PACIFIC_DEALS),
  },
  {
    id: 'americas',
    title: 'Americas & Caribbean',
    description: 'Short hops and beach getaways from major US hubs.',
